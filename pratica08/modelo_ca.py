...
# Função pra divisão do conjunto de dados
from sklearn.model_selection import train_test_split

# Carregando o data set de CA de mama
...
# Divisão  dos dados para treino 70% e para avaliação (teste) 30%
...
y_pred = modelo.predict(X_test) # Previsões de clase ( 0 ou 1) (maligno ou benigno)
y_pred_proba = modelo.predict_proba(X_test)[:,1] # Probabilidade de classe positiva(1) (benigno)

# Calcular as métricas par avaliação
